            ...
            <div className="bg-neutral-900/80 backdrop-blur-md p-8 rounded-lg shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] border border-neutral-800 border-b-[8px] border-black relative overflow-hidden">
                ...
                <form onSubmit={handleSignIn} className="space-y-5">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <a href="#" className="text-xs font-medium text-brand-400 hover:text-brand-300 hover:underline">Forgot password?</a>
                        </div>
                        <div className="relative">
                            <input 
                                type="password" 
                ...
                <div className="mt-8 pt-6 border-t border-neutral-800 text-center">
                    <p className="text-sm text-neutral-500">
                        Don&apos;t have an account? <Link href="/signup" className="font-bold text-brand-400 hover:text-brand-300 hover:underline">Sign Up</Link>
                    </p>
                </div>
            </div>
        </div>
